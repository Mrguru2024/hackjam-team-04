...
const ONBOARDING_STEPS = [
  {
    ...
    options: [
      ...
      {
        label: "💼 I'm currently employed and seeking growth",
        tag: "career-growth",
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "🚀 I want to switch industries or roles",
        tag: "career-change",
      },
      {
        label: "🏆 I want to earn recognition or credentials",
        tag: "goal-oriented",
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "👥 I want to connect with peers or mentors",
