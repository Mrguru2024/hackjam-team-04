      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white dark:bg-surface-default rounded-2xl shadow-lg p-8 border border-border-default">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-title mb-2">Log Your Task</h1>
            <p className="text-body">Record your latest achievement and earn XP</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="type" className="block text-sm font-medium text-title mb-2">
                Task Type
              </label>
              <select
                id="type"
            ...
            <div className="bg-primary-subtle dark:bg-primary-default/10 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-primary-default">XP Reward</span>
                <span className="text-lg font-bold text-primary-default">+10 XP</span>
              </div>
            </div>
