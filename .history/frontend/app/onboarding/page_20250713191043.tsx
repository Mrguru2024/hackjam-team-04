...
const TAGS = ["Career", "Learning", "Community"];
...
const OnboardingPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    setError("");
    try {
      await updateUserTags(user.uid, selectedTags);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-surface-default rounded-2xl shadow-xl p-8 border border-border-default">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-title mb-2">Welcome to LevelUp!</h1>
            <p className="text-body">Let's set up your profile in 3 simple steps</p>
          </div>
          
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <span className="text-sm font-medium text-caption">Step {step + 1} of 3</span>
            ...
            <div className="mb-6">
              <h2 className="text-xl font-bold mb-4 text-title">Select your focus area(s):</h2>
