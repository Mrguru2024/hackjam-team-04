...
const BadgesPage = () => {
  ...
  useEffect(() => {
    ...
    setLoadingData(true);
    fetchUserInfo(user.uid).then((info) => {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-surface-default rounded-2xl shadow-lg p-8 border border-border-default">
          <div className="text-center mb-8">
            ...
            <p className="text-body">Celebrate your achievements and progress</p>
          </div>

          {badges.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-6xl mb-6">🏅</div>
              <h2 className="text-2xl font-bold text-title mb-4">No badges yet</h2>
